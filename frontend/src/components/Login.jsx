...
const Login = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen w-full">
      {/* Left Image / Visual */}
      <div className="hidden lg:flex lg:w-2/3 h-full">
        <img
      ...
      {/* Login Form */}
      <div className="w-full lg:w-1/3 flex flex-col justify-center items-center px-6 py-12 bg-gray-900">
        ...
        {/* Bot Button with line animation */}
        <button
          className="relative px-6 py-3 mt-2 rounded-md overflow-hidden text-white font-medium bg-gray-700 w-full max-w-sm"
